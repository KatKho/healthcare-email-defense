...
- Logs/Observability: AWS CloudWatch — see [`evidence/`](./evidence/) for log group details
...
- **Why (top evidence):**  
  - System has been running continuously since 11/19/25 with no crashes  
...
- **Test steps:** see [`docs/test-plan.md`](docs/test-plan.md)
